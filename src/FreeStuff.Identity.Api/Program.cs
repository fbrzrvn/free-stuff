...
using System.Text;
using FreeStuff.Contracts.AuthenticateRequest;
using FreeStuff.Identity.Api.Domain;
using FreeStuff.Identity.Api.Infrastructure;
...
var builder = WebApplication.CreateBuilder(args);
{
    ...
    builder.Services.AddDbContext<FreeStuffIdentityDbContext>(options =>
...
async Task SeedData()
{
    ...
    var context     = scope.ServiceProvider.GetRequiredService<FreeStuffIdentityDbContext>();
